        ...
        <section class="stat-admin">
            <div class="stat-admin-name">
                ...
                <div class="stat-admin-name-button">
                    <a href="/admin/category_add.php">
                        <button class="create-Sth"><i class="fas fa-plus-square"></i> Добавить категорию</button>
                    </a>
                </div>
            </div>
            <div class="table-container">
                ...
                ?>
                        <div class="table-line">
                            <div class="table-line-item"><?= $row['category_name']; ?></div>
                            <div class="table-line-item">
                                <a style="margin-right: 10px;" href="./actions/category_delete.php?id=<?= $row['category_id']; ?>">
                                    <button class="delete-Sth"><i class="fas fa-trash"></i></button>
                                </a>
                                <a href="/admin/category_update.php?id=<?= $row['category_id']; ?>">
